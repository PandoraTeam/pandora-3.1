...
trait HasEnumOptions {
	...
	public static function getOptions(): array {
		return array_filter(self::$titles, static function($key) {
	...
	public static function getOptionsOnly(array $only = []): array {
		return array_filter(self::$titles, static function($key) use ($only) {
	...
	public static function getOptionsExclude(array $exclude = []): array {
		return array_filter(self::$titles, static function($key) use ($exclude) {
